...
CREATE TABLE `comments` (
  ...
  `perent_id` varchar(100) NOT NULL,
  `dt` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `comments` (`sr`, `name`, `email`, `message`, `blog_id`, `perent_id`, `dt`) VALUES
(5, 'ankit', 'ankit@ankit.ci', 'hello world', 3, '0', '2024-02-20 23:27:13'),
(6, 'Another', 'reply@jfhg.co', 'anotehre commetn', 3, '0', '2024-02-20 23:39:58'),
(7, 'ankit', 'ankit@ankit.ci', 'this comment is for anoter blog no 2', 2, '0', '2024-02-20 23:41:45');
...
INSERT INTO `contactpage` (`sr`, `name`, `email`, `subject`, `phone`, `message`, `dt`) VALUES
(1, '', '', '', '', '', '2024-01-31 22:38:26'),
(2, 'Ankit', 'Amandeepsingh1691998@gmail.com', 'dddd', 'dd', 'df', '2024-01-31 22:40:49');
...
(1, 'Ankit', 'ankitbkana@outlook.com', '447d2c8dc25efbc493788a322f1a00e7', '2024-01-13 19:12:09');
...
--
ALTER TABLE `blogs`
  MODIFY `blog_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `comments`
--
ALTER TABLE `comments`
  MODIFY `sr` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
